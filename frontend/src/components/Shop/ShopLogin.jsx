                ...
                <div className="bg-white py-8 px-4 shadow-lg border-2 border-ink/5 sm:rounded-2xl sm:px-10">
                    <form onSubmit={(e) => handleSubmitBtn(e)}
                        ...
                        <div className="flex flex-col space-y-2 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between text-sm">
                            ...
                            <div>
                                <a href=".forgot-password" className="font-medium text-brand-text hover:text-brand-dark">
                        ...
                        <div className="flex items-center justify-center w-full text-sm pt-2">
                            ...
                            <Link to="/create-shop" className="text-brand-text font-medium pl-2 hover:underline">
                                Sign Up
                            </Link>
                        </div>
                    </form>
